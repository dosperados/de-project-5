...
Поэтому предлагаю сделать партиционирование и группировку по полю load_dt (содержит дату обновления витрины, у всех 10 записей одинаковое значение этого поля) - тогда все 10 строк будут находится на одной ноде и в одной партиции.
